...
namespace RE
{
	...
	public:
		...
		virtual void         SendContainerChangedEvent(const TESObjectREFR* a_oldContainer, const TESObjectREFR* a_newContainer, const TESBoundObject* a_baseObject, std::int32_t a_count, std::uint32_t a_referenceFormID, std::uint16_t a_uniqueID, std::uint64_t a_arg7, std::uint32_t a_arg8) const;  // 091
